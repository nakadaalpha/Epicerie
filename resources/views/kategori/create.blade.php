...
<head>
    ...
    <title>Tambah Kategori - ÈPICERIE</title>
...
<body class="bg-gradient-to-br from-blue-500 to-teal-400 min-h-screen font-sans">
                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nama_kategori" class="w-full p-3 pl-10 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50 transition" placeholder="Contoh: Makanan Ringan" required>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 p-4 rounded-2xl border border-blue-100 flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-blue-600 text-xs mt-1 leading-relaxed">
                                    Gambar kategori akan ditampilkan di halaman depan inventaris dan laporan. Gunakan gambar dengan rasio 1:1 (persegi) untuk hasil terbaik.
                                </p>
                            </div>
                        </div>
    ...
    <script>
        ...
        removeBtn.addEventListener('click', (e) => {
            e.preventDefault();
            e.stopPropagation(); // Stop click tembus ke input file
            inputFile.value = '';
