    ...
    <div class="max-w-[1000px] mx-auto px-4 py-8 flex flex-col md:flex-row gap-8">
        ...
        <div class="flex-1">
            ...
            <div class="flex gap-2 border-b border-gray-200 mb-6 overflow-x-auto pb-1 no-scrollbar">
                ...
                <a href="{{ route('kiosk.riwayat', ['status' => 'diproses']) }}"
                    class="{{ request('status') == 'diproses' ? 'text-blue-600 font-bold border-b-2 border-blue-600 bg-blue-50' : 'text-gray-500 hover:text-blue-600 font-medium hover:bg-gray-100' }} px-4 py-2 rounded-t-lg transition whitespace-nowrap text-sm">
                    <i class="fa-solid fa-box-open mr-1"></i> Diproses
                </a>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition group">
                    ...
                    <div class="bg-gray-50/50 px-6 py-4 border-b border-gray-100 flex flex-col md:flex-row justify-between md:items-center gap-3">
                        ...
                        <div>
                            ...
                            // Penyesuaian logika warna badge
                            ...
                            // Mapping nama status jika masih tersimpan 'dikemas' di database lama
                            if(strtolower($status) == 'dikemas') { $status = 'Diproses'; }
                            @endphp
                    ...
                    <div class="px-6 py-4 border-t border-gray-100 flex justify-between items-center bg-white">
                        ...
                        <div class="flex gap-3">
                            @if(in_array(strtolower($trx->status), ['dikemas', 'diproses', 'dikirim']))
